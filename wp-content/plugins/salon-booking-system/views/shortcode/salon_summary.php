...
} elseif ($errors && in_array(SLN_Shortcode_Salon_SummaryStep::SERVICES_DATA_EMPTY, $errors)) {
...
<form method="post" action="<?php echo $formAction ?>" role="form" id="salon-step-summary">
  ...
  <div class="row">
    ...
    if (!empty($name)) {
        ...
        <?php _e('様,', 'salon-booking-system'); ?>
        <br />
        <?php } ?>
        <?php _e('ご予約の内容をご確認の上、ご確認ください：', 'salon-booking-system') ?>
      </p>
    </div>
  </div>
